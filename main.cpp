...
int main() {
    ...
    cout << "Element at index 1: " << myArray.getAt(1) << endl;

    myArray.setAt(1, 15);
    cout << "New element at index 1: " << myArray.getAt(1) << endl;

    myArray.removeAt(2);
    cout << "After removal, element at index 2: " << myArray.getAt(2) << endl;
...
New element at index 1: 15
After removal, element at index 2: 12

C:\Users\David\source\repos\Queue double linked list\x64\Debug\Queue double linked list.exe (процесс 19552) завершил работу с кодом 0 (0x0).
